...
object RomLauncher {
    ...
    fun launch(
        ...
        if (platform == null) {
            toast(activity, "Unknown platform: ${entry.platformId}")
            return false
        }
        ...
        if (template == null) {
            toast(activity, "${platform.displayName} player not installed")
            return false
        }
        ...
        return try {
            ...
            toast(activity, "${template.displayName} not installed")
            false
        }
    }
