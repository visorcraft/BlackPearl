...
- **Game Mode** — card carousel with Recent / Top (most played) / Continue / Random / Favorites / A–Z / New (unplayed) filters, A–Z letter jump strip, platform chips, unified app+ROM search, and last-played + playtime card meta.
...
- **ROM library** — SAF tree grants only (no broad storage permission); offline-first art; optional SteamGridDB scrape and RetroAchievements credentials.
