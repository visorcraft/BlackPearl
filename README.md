...
- **Game Mode** — card carousel with Recent / Continue / Favorites filters, platform chips, and playtime meta.
...
- **Quick Panel** — Select (default) opens Wi‑Fi / Continue / theme / settings shortcuts.
